...
export default function Nav() {
  ...
  return (
   <>
    <aside className={`fixed transition-all duration-500  ${nav === true ? 'left-0' : '-left-28'} top-0 border-r-[1px] p-10 w-[110px]  min-h-screen flex flex-col justify-between z-50 ${darkMode === true ? 'bg-black border-gray-900' : 'bg-white border-gray-300'}  md:left-0`}>
        <a href="">

...
function App() {
  ...
  return (
     ...
     <Nav/>
      ...
      <Element name="Habilidades" className=' md:mt-96 h-screen -ml-4 md:ml-10   flex flex-col justify-center items-center' >
       <Skill/>
      </Element>
      ...
      <Element name="Proyectos" className={`w-11/12   mt-60 h-screen  flex flex-col items-center   gap-5 md:mt-0`}>
       ...
       {
         service === false ? <div className=" w-4/5 h-full grid grid-cols-1 gap-4 md:grid-cols-2">
         {
